describe('Restful Booker API Tests', () => {
    ...
    it('Create Booking', () => {
      ...
      cy.request({
        ...
        expect(response.body.booking.bookingdates.checkin).to.equal("2023-11-01");
        expect(response.body.booking.bookingdates.checkout).to.equal("2023-11-05");
    ...
    it('Update Booking', () => {
        ...
        cy.request({
          ...
          expect(response.status).to.equal(200);
          expect(response.body.firstname).to.equal(updatedBookingData.firstname);
          expect(response.body.lastname).to.equal(updatedBookingData.lastname);
          expect(response.body.totalprice).to.equal(updatedBookingData.totalprice);
          expect(response.body.depositpaid).to.equal(updatedBookingData.depositpaid);
